...
export default function About () {
    ...
    return (
        <div id="about" className="max-w-[90%] md:max-w-[1280px] flex flex-col md:flex-row items-center justify-center gap-12 w-full h-auto">
            <div className='bg-white/40 dark:bg-black/60 text-black dark:text-white w-[100%] md:w-[80%] rounded-xl mx-4 p-4 flex flex-col md:flex-row h-auto'>
                <article className='gap-4 w-full'>
                    <h2 className='text-neutral-200 dark:text-white uppercase text-xl md:text-3xl my-4 tracking-widest text-center'>Jonas Risløw Iversen</h2>
