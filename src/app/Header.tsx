...
export default function Header() {
    ...
    return (
            <div className='sticky top-0 z-50 w-full justify-start items-start md:h-14 max-w-screen backdrop-blur-md'>
                <div className='w-full justify-start items-start md:h-14'>
