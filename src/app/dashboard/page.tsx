...
export default function Dashboard() {
    return (
        <DashProvider>
            <AuthProvider>
                <div className="bg-gray-300 dark:bg-slate-800 min-h-screen max-h-screen overflow-hidden h-screen">
                    ...
                    <div id="main_div" className="flex h-full w-full justify-start flex-row items-start">
                        ...
                        <div className="w-full md:w-5/6 bg-slate-100 min-h-[400px] h-full">
                            <DashboardHeader/>
                            <DashboardContent/>
                        </div>
                    </div>
